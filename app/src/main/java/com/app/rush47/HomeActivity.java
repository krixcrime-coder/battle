 ...
 * fragment_container. Only Play is a real screen right now; Earn and
 * Account show a "coming soon" placeholder until those are built.
 */
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_earn) {
                showFragment(StubTabFragment.newInstance(getString(R.string.tab_earn)), TAG_EARN);
                return true;
            } else if (id == R.id.nav_play) {
                showFragment(new PlayFragment(), TAG_PLAY);
                return true;
            } else if (id == R.id.nav_account) {
                showFragment(StubTabFragment.newInstance(getString(R.string.tab_account)), TAG_ACCOUNT);
                return true;
            }
            return false;
        });

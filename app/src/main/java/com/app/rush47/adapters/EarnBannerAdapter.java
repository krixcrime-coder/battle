 ...
 * (@id/earnBannerList in fragment_earn.xml). Same Banner model and same
 * banners.php contract as the Play tab's auto-scroll pager - the only
 * difference is these are stacked full-width instead of swiped, and the
 * request sends {"page":"earn"} so the backend can tell the two apart.
 * Tapping a banner opens its redirect_url in the browser, same as Play.
 */

 ...
 *
 * Rows that show "coming soon" for now because there is no matching
 * screen/API in this codebase yet (My Matches, My Order, My Statistics,
 * My Rewards, Announcement, Top Players, Leaderboard, App Tutorial,
 * Terms & Conditions, Change Language). Tell me which of these you want
 * built next and I'll wire up a real screen for it.
 */

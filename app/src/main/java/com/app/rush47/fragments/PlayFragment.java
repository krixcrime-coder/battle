    ...
    private void handleWalletResponse(JSONObject response) {
        try {
            ...
            if (TextUtils.equals(status, "true")) {
                ...
                ongoingCount.setText(data.optString("ongoing_count", "0") + "\n" + getString(R.string.ongoing));
                upcomingCount.setText(data.optString("upcoming_count", "0") + "\n" + getString(R.string.upcoming));
                completedCount.setText(data.optString("completed_count", "0") + "\n" + getString(R.string.completed));
            }
        } catch (JSONException ignored) {
        } finally {
            finishLoading();

...
public class EarnFragment extends Fragment {
    ...
    // ---------------------------------------------------------------
    // Banners: same banners.php contract the Play tab uses, but this
    // request sends {"page":"earn"} so the backend can return a
    // different set of banners for this tab. See BACKEND_SETUP.md /
    // sql/banners_table.sql for the table + endpoint this expects.
    // If the server has none yet (or the request fails), the local
    // "Wait For End" banner is shown so the section is never empty.
    // ---------------------------------------------------------------

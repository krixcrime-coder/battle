...
/**
 * Editable "My Profile" screen: First/Last name, Username, Email,
 * Mobile, DOB, Gender + "Update Profile" button (-> update_profile.php),
 * plus a "Reset Password" section (Old/New password -> reset_password.php).
 *
